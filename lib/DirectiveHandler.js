...
module.exports = (function() {
	...
	DirectiveHandler.prototype = {
		...
		handleDirective: function(directive, directiveName, currentFile, variables, inputEncoding, outputEncoding) {
			...
			switch (directiveName) {
				...
				case "include":
					interpolate.apply(this);
					return this._handleInclude(attributes, currentFile, variables, inputEncoding, outputEncoding);
			}
		...
		_handleInclude: function(attributes, currentFile, variables, inputEncoding, outputEncoding) {
			...
			if (attributeName === "file") {
				results = {output: this.ioUtils.readFileSync(currentFile, filename, inputEncoding, outputEncoding)};
			} else if (attributeName === "virtual") {
				results = {output: this.ioUtils.readVirtualSync(currentFile, filename, inputEncoding, outputEncoding)};
			}
